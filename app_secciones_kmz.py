...
APP_VERSION = "v12_utm_19s_3d_seleccion_modelacion_fix"
...
with col3:
    km_end = st.number_input("Km final de generación", min_value=0.0, max_value=max(axis_length_km, 0.001), value=float(round(axis_length_km, 3)), step=0.1, format="%.3f")
